...
const DashboardMyApprovalsPage = () => {
        ...
        <div className="flex flex-col gap-[23px] justify-start w-full">
          ...
          <div className="flex flex-col items-start justify-start md:ml-[0] ml-[120px] md:px-5 w-[90%] md:w-full">
            <Text
              ...
              onClick={() => navigate("/dashboardmycr")}
            >
              Dashboard
            </Text>
            ...
            <div className="bg-white-A700 md:h-[290px] h-[327px] sm:h-[393px] mt-2.5 pb-[21px] relative rounded-[11px] shadow-bs1 w-full">
              <div className="absolute flex flex-col inset-x-[0] items-center justify-start mx-auto top-[0] w-full">
                <div className="flex flex-col items-center justify-start w-full">
                  <div className="bg-blue_gray-900 flex sm:flex-col flex-row sm:gap-5 items-start justify-start p-3.5 rounded-tl-[7px] rounded-tr-[7px] w-full">
                    <Text
                      className="ml-5 sm:ml-[0] sm:mt-0 mt-[5px] text-sm text-white-A700"
                      size="txtPoppinsMedium14WhiteA700"
                    >
                      CR ID
                    </Text>
                    <Text
                      className="sm:ml-[0] ml-[516px] sm:mt-0 mt-1.5 text-sm text-white-A700"
                      size="txtPoppinsMedium14WhiteA700"
                    >
                      Approved time
                    </Text>
                    <Text
                      className="sm:ml-[0] ml-[119px] sm:mt-0 mt-[5px] text-sm text-white-A700"
                      size="txtPoppinsMedium14WhiteA700"
                    >
                      Status
                    </Text>
                    <Text
                      className="sm:ml-[0] ml-[295px] sm:mt-0 mt-[5px] text-sm text-white-A700"
                      size="txtPoppinsMedium14WhiteA700"
                    >
                      Action
                    </Text>
              ...
              <div className="absolute flex flex-col gap-[27px] h-max inset-y-[0] items-center justify-start left-[10%] my-auto w-[4%]">
                <Text
                ...
                <div className="flex flex-col gap-[36px] items-center justify-start">
                  <Text
              ...
              <div className="absolute flex flex-col gap-[30px] h-max inset-y-[0] items-center justify-start left-[19%] my-auto w-[10%]">
                <Text
                  className="text-sm text-white-A700 mt-[-20]"
                  size="txtPoppinsMedium14WhiteA700"
                >
                  Launch Category
                </Text>
              ...
              <div className="absolute flex flex-col gap-[20px] h-max inset-y-[0] items-center justify-start left-[33%] my-auto w-[8%]">
                <Text
                  className="text-sm text-white-A700"
                  size="txtPoppinsMedium14WhiteA700"
                >
              ...
              <div className="absolute flex flex-col gap-[23px] h-max inset-y-[0] items-center justify-start my-auto right-[30%] w-1/4">
              ...
              <div className="absolute bottom-[6%] flex flex-row gap-[74px] items-center justify-center right-[30%] w-1/4">
                <Text
                  className="text-blue_gray-900 text-center text-xs"
                  size="txtPoppinsRegular12Bluegray900"
                >
              ...
              <div className="absolute bottom-[8%] flex flex-col gap-[35px] items-center justify-start right-[20%]">
                <Text
              ...
              <div className="absolute flex flex-col h-max inset-y-[0] items-center justify-start my-auto right-[2%] w-[14%]">
                <div className="flex flex-row items-center justify-evenly w-full">
                  ...
                  <Text
                    className="bg-red-800 h-[25px] justify-center sm:px-5 px-6 py-[3px] rounded-[7px] text-white-A700 text-xs w-[85px]"
                    size="txtPoppinsRegular12WhiteA700"
                  >
                    Reject
                  </Text>
                ...
                <Text
                  className="mt-[30px] text-blue_gray-900 text-xs"
                  size="txtPoppinsRegular12Bluegray900"
                >
                  -
                </Text>
                ...
                <div className="flex flex-row items-center justify-evenly mt-8 w-full">
                  <Text
                    className="bg-light_green-800 h-[25px] justify-center px-[17px] py-[3px] rounded-[7px] text-white-A700 text-xs w-[85px]"
                    size="txtPoppinsRegular12WhiteA700"
                  >
              ...
              <div className="absolute bottom-[7%] flex flex-row items-center justify-center right-[2%] w-[14%]">
                <Text
                  className="bg-light_green-800 h-[25px] justify-center px-[17px] py-[3px] rounded-[7px] text-white-A700 text-xs w-[85px]"
                  size="txtPoppinsRegular12WhiteA700"
                >
...
export default DashboardMyApprovalsPage;
